package io.github.kingw0.mybatis.plugin.test;
...
import io.github.kingw0.mybatis.plugin.sql.Table;
import io.github.kingw0.mybatis.plugin.sql.Update;
import io.github.kingw0.mybatis.plugin.sql.condition.Condition;
import io.github.kingw0.mybatis.plugin.sql.condition.Exists;
...
import static io.github.kingw0.mybatis.plugin.sql.expression.Binder.bind;
...
//                        .and(exists(new Select().columns(text("X")).from("t_test").where(column("name_").eq("teddy"))))
    ...
    public static class Parent {
        @io.github.kingw0.mybatis.plugin.annotation.Column(name = "id_")
        private long id;
    }

    @Tab(name = "t_child_")
    public static class Child extends Parent {
        @io.github.kingw0.mybatis.plugin.annotation.Column(name = "name_")
        private String name;

        @io.github.kingw0.mybatis.plugin.annotation.Column(name = "age_")
        private long age;
