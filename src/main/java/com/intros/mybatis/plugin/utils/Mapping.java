...
public class Mapping {
    ...
    public static <S extends Sql<S>> List<Column<S>> columns(Class<?> mappingClass, String table, Predicate<ColumnInfo> filter) {
        return columns(mappingClass, table, true, filter);
    }
